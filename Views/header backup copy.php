                                ...
                                <nav class="d-none d-lg-block">
                                    <ul id="navigation">
                                        ...
                                        ?>
                                            ...
                                            <li><a href="index.php?page=profil" class="btn head-btn1" style="font-size: 20px;">Profil</a></li>
                                            <li><a href="index.php?page=deconnection" style="color: #38B6FF;">Deconnection</a></li>
                                        <?php } else { ?>
                                            <li><a href="index.php?page=connexion" class="btn head-btn1">Se connecter</a></li>
                                            <li><a href="index.php?page=registration" class="btn head-btn1">Créer un compte</a></li>
                                        <?php } ?>
                                    </ul>
                                </nav>
                            </div>
