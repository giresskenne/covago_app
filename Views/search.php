...
<html class="no-js" lang="zxx">
    ...
    $req->execute(array($_POST["lieuDep"],$_POST["lieuArriv"]));
...
<div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="hero-cap text-center">
                        <h2><i>Désolé  mais aucun voyage ne correspond a votre recherche.Vueillez effectuer une autre recherche<a href="index.php?page=voyages" class="text text-primary"> Trouver un voyage </a></i> </h2> 
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <section class="featured-job-area">
                            <div class="container">
                               ...
                               $bdd=getBdd();
                                ...
                                $qer = $bdd->prepare("SELECT * FROM journey WHERE lieuDep=? AND lieuArriv=? order by id asc limit $depart,$nbre_element_page");
                                $qer->execute(array($_POST["lieuDep"],$_POST["lieuArriv"])); 
