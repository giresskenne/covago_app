$(document).ready(function () {
    ...
    $(".edit-button").click(function () {
        const targetFieldset = $(this).data("target"); // Get the target fieldset class
        $(".form-card3").hide(); // Hide the confirmation fieldset
        $(targetFieldset).show(); // Show the target fieldset
    });
